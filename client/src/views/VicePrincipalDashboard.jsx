...
export default function VicePrincipalDashboard() {
  ...
  // Modal states: Appoint Class Teacher
  ...
  const handleAddProxy = async (e) => {
    ...
    try {
      ...
      setProxyFormData({ absentTeacher: '', section: 'Grade 9-A', period: 'Period 1 (08:30 AM)', substitute: '' });
  ...
  const openAssignModalForStudent = (student) => {
    const studentGrade = student.grade || 'Grade 9';
  ...
  // Handle Appointing Class Teacher
  const handleAssignClassTeacher = async (e) => {
    ...
    try {
      ...
      const res = await api.assignClassTeacher(payload);
      showToast(res.message || 'Class teacher appointed and synced to records!', 'success');
      ...
      showToast(err.message || 'Failed to appoint class teacher', 'error');
    } finally {
      setAssigning(false);
    }
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2.5 self-start md:self-auto">
          ...
          >
            <UserPlus className="w-4 h-4" /> Appoint Class Teacher
          </button>
          <button
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 pb-3 mb-6">
        ...
        >
          <UserPlus className="w-4 h-4" /> Appoint Class Teacher & Student Allocation
                          ...
                          <td className="py-3 px-4 text-right">
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                ...
                                title="Appoint / Reassign Class Teacher"
                              >
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 border border-slate-200">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 mb-4">
              <div>
                <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                  <UserPlus className="w-5 h-5 text-indigo-600" /> Appoint Class Teacher
                </h3>
                <p className="text-xs text-slate-500 mt-0.5">
                  Assign an appointed faculty member to lead homeroom governance for admitted students.
                </p>
              </div>
              <button 
            ...
            <form onSubmit={handleAssignClassTeacher} className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2 p-2.5 rounded-xl border border-slate-200 bg-slate-50/50 cursor-pointer text-xs">
                    ...
                    />
                    <div>
                      <span className="font-bold text-slate-800">All Admitted Students in {assignForm.grade} - Section {assignForm.section}</span>
                      <p className="text-[11px] text-slate-500">
                        Automatically updates homeroom class teacher for every admitted student enrolled in this class.
                      </p>
                    </div>
                  </label>
                  ...
                  {assignForm.selectedStudentIds.length > 0 && (
                    <label className="flex items-center gap-2 p-2.5 rounded-xl border border-slate-200 bg-slate-50/50 cursor-pointer text-xs">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-slate-500">
                          Appoint this teacher specifically for the student you selected.
                        </p>
                      </div>
                    </label>
                  )}
              ...
              <div className="p-3 bg-indigo-50/80 rounded-xl border border-indigo-100 flex items-start gap-2 text-xs text-indigo-900">
                ...
                <div>
                  <span className="font-bold">Live Synchronized Action:</span>
                  <p className="text-[11px] text-indigo-700 mt-0.5">
                    This updates student profiles, adds the homeroom assignment to the teacher's faculty profile in MongoDB, and promotes their user access to Class Teacher Homeroom.
                  </p>
                </div>
              </div>
